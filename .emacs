...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (company racer rust-mode lua-mode yaml-mode cargo company racer rust-mode protobuf-mode smex zenburn-theme yasnippet use-package undo-tree markdown-mode magit key-chord ido-vertical-mode hydra flx-ido auctex ace-jump-mode solidity-mode))))
(custom-set-faces
